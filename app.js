const workProjects = [
  {
    ...
    achievements: [
      ...
      {
        title: "상품 상태 일관성 확보",
        cause: "상품과 포스트의 N:M 관계로 인한 화면별 상태 관리 방식 분산 위험",
        process: "공통 서비스 레이어에서 연결 관계와 상태 갱신 흐름 관리",
        result: "상품 상세와 상품 미리보기 전시 영역 간 데이터 일관성 확보"
      },
      {
        title: "변경 안정성 강화",
      ...
      },
      {
        ...
        process: "날씨별 콘텐츠 추천 페이지와 상품 전시 영역 Flutter 앱에 추가",
